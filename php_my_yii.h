...
#define phpext_my_yii_ptr &my_yii_module_entry

#define PHP_MY_YII_VERSION "0.1.0" /* Replace with version number for your extension */
...
#define YII_UNINITIALIZED_OBJECT(obj) \
do { \
	zval_dtor(obj); \
	ZVAL_FALSE(obj); \
} while(0)
...
#ifdef PHP_WIN32
#	define PHP_MY_YII_API __declspec(dllexport)
#elif defined(__GNUC__) && __GNUC__ >= 4
#	define PHP_MY_YII_API __attribute__ ((visibility("default")))
#else
#	define PHP_MY_YII_API
#endif
...
/* In every utility function you add that needs to use variables 
   ...
   the globals in your function as MY_YII_G(variable).  You are 
   encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/

#ifdef ZTS
#define MY_YII_G(v) TSRMG(my_yii_globals_id, zend_my_yii_globals *, v)
#else
